...
const toolProperties: Record<string, Record<string, unknown>> = {
  ...
  'sheets.updateCell': { spreadsheetId: stringProperty('Spreadsheet id.'), range: stringProperty('A1 cell to write.'), value: { description: 'Bounded primitive cell value: string, finite number, boolean, or null.' }, inputMode: { type: 'string', enum: ['literal', 'userEntered'], description: 'Defaults to literal (RAW). userEntered intentionally enables Sheets parsing, including formulas.' } },
