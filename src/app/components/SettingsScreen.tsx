    ...
    <main className="settings-screen" style={{ fontFamily: fontFamilyForCss(font), '--body-font-size': '15px' } as React.CSSProperties}>
      ...
      <div className="settings-layout">
        ...
        <section className="settings-panel" aria-live="polite">
          ...
          {section === 'memory' && <div className="settings-copy"><span className="panel-kicker">CONTINUITY</span><h2>Memory & continuity</h2><p>Shape how Elara remembers you and how readily she brings shared history back into conversation. These controls change memory behaviour, not the character prompt.</p><MemoryContinuitySettings /><div className="memory-bank-advanced"><div className="memory-bank-advanced__heading"><span>ADVANCED</span><strong>Memory Bank</strong><p>Inspect, search, edit, archive, promote, restore, import, export, or permanently delete durable memories in the canonical store.</p></div><DurableMemorySettings /></div></div>}
