...
export const googleScopeRegistry: readonly GoogleScopeDescriptor[] = [
  { capability: 'google.account', scope: 'https://www.googleapis.com/auth/userinfo.email', access: 'read', sensitivity: 'non-sensitive', rationale: 'Anchor Google account identity. Settings onboarding combines this narrow identity capability with the reviewed Workspace scope bundle in one user-driven GIS consent request.' },
  ...
  { capability: 'gmail.modify', scope: 'https://www.googleapis.com/auth/gmail.modify', access: 'write', sensitivity: 'restricted', rationale: 'Modify message/thread labels and trash state without requesting the broader permanent-delete scope.' },
  { capability: 'gmail.labels', scope: 'https://www.googleapis.com/auth/gmail.labels', access: 'write', sensitivity: 'non-sensitive', rationale: 'Manage Gmail USER labels through Google\'s dedicated non-sensitive label scope.' },
  ...
  { capability: 'sheets.write', scope: 'https://www.googleapis.com/auth/drive.file', access: 'write', sensitivity: 'non-sensitive', rationale: 'App-file Sheets writes. Never inferred from drive.file alone.' },
