...
if (!clickUpOauthProviderSource.includes("token.startsWith('pk_') ? token : `Bearer ${token}`")) throw new Error('Reliability gate: ClickUp provider auth must preserve distinct personal-token and OAuth Authorization forms.');
