...
const toolProperties: Record<string, Record<string, unknown>> = {
  ...
  'sheets.exportSpreadsheet': { spreadsheetId: stringProperty('Spreadsheet id.'), format: { type: 'string', enum: ['pdf', 'xlsx'], description: 'Export format.' }, maxBytes: { type: 'integer', minimum: 1, maximum: 10 * 1024 * 1024, description: 'Optional transfer ceiling; never above 10 MiB.' } },
