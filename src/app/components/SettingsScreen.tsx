...
export function SettingsScreen({
  ...
  return (
    <main className="settings-screen" style={{ fontFamily: fontFamilyForCss(font), '--body-font-size': `${fontSize}px`, height: '100dvh', overflow: 'hidden' } as React.CSSProperties}>
      ...
      <div className="settings-layout" style={{ height: 'calc(100dvh - 84px)', minHeight: 0 }}>
        <nav className="settings-nav" aria-label="Settings sections" style={{ overflow: 'hidden', minHeight: 0 }}>
        ...
        <section className="settings-panel" aria-live="polite" style={{ minHeight: 0, overflow: 'hidden' }}>
          <div className="settings-panel__scroll" style={{ height: '100%', overflowY: 'auto', overflowX: 'hidden', overscrollBehavior: 'contain', scrollbarGutter: 'stable' }}>
