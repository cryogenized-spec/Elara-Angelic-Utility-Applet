...
const settingsSections = [
  ...
  { id: 'memory', label: 'Memory Bank', icon: 'markdown' as const },
    ...
    <main className="settings-screen" style={{ fontFamily: fontFamilyForCss(font), '--body-font-size': '15px' } as React.CSSProperties}>
      ...
      <div className="settings-layout">
        ...
        <section className="settings-panel" aria-live="polite">
          ...
          {section === 'google' && <div className="settings-copy"><span className="panel-kicker">ACCOUNT & AUTHORIZATION</span><h2>Google</h2><p>Connect Google Workspace once to review the supported permissions together in Google’s authorization screen. Elara then reflects the scopes Google actually grants; authorization state and secrets remain owned by the protected OAuth authority.</p><GoogleOAuthSettings /><WorkspaceShortcutSettings /></div>}
