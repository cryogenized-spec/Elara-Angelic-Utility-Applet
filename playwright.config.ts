...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: /(?:mobile-reliability|vtt|media-handoff|media-delivery\.phase3|media-lifecycle\.acceptance|generation-activity|google-drive|google-picker)\.spec\.ts/,
      use: {
