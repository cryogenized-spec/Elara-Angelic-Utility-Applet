...
if (!googleBrokerSource.includes('checkbox.checked = requests.length === 1;')) throw new Error('Reliability gate: grouped mutation confirmations must default unselected.');
