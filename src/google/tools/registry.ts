...
export const googleToolRegistry: readonly GoogleToolDescriptor[] = [
  ...
  { name: 'gmail.replyMessage', risk: 'send', capability: 'gmail.send', exposure: 'gemini', description: 'Verify a target Gmail thread/message through Gmail read authority, then send a plain-text reply through explicit send authority.' },
