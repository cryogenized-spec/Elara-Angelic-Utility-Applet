...
const requiredFiles = [
  ...
  'src/google/drive/limits.ts', 'src/google/drive/errors.ts', 'src/google/drive/download.ts', 'src/google/tools/drive-parity.test.ts',
