...
export const googleScopeRegistry: readonly GoogleScopeDescriptor[] = [
  ...
  { capability: 'chat.write', scope: 'https://www.googleapis.com/auth/chat.spaces', access: 'write', sensitivity: 'sensitive', rationale: 'Temporary application mapping pending exact method-by-method Chat scope audit.' },
