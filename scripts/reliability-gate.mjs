...
const requiredFiles = [
  ...
  'src/google/drive/limits.ts', 'src/google/drive/errors.ts', 'src/google/drive/download.ts', 'src/google/drive/create-replay.ts', 'src/google/drive/create-replay.test.ts', 'src/google/tools/drive-parity.test.ts', 'src/google/tools/drive-write-parity.test.ts',
