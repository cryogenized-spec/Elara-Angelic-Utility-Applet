  ...
  return <main className="settings-screen" style={{ fontFamily: fontFamilyForCss(font), '--body-font-size': `${fontSize}px` } as React.CSSProperties}>
    ...
    <div className="settings-layout">
      ...
      <section className="settings-panel" aria-live="polite">
        ...
        {section === 'security' && <div className="settings-copy"><span className="panel-kicker">SECURITY</span><h2>API Lockbox</h2><p>The Gemini API key is stored locally in this browser and supplied directly to the Gemini client when needed.</p><GeminiApiLockbox /></div>}
      </section>
    </div>
  </main>;
}
